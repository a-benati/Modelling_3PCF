...
namespace cbl {
  ...
  namespace data {
    ...
    public:
      ...
      /**
       *  @brief get the correlation matrix
       *
       ...
       *
       * This uses the standard estimator of the covariance
       *
       ...
       * \f$f\f$ is a normalization factor the user can provide in input.
       *
       * This function takes a vector of vectors of vectors of doubles. The first index is the considered probe, the second index is the considered mock catalogue and the third index is the considered position in the dataset. This should be used when multiple probes (such as \f$xi_0+xi_2+xi_4\f$ or \f$xi\f$+\f$zeta\f$, etc...) are considered.
       *
       * @param dataset vector of vectors of vectors of doubles
       *
       * @param normalization the normalization factor
       *
       * @param prec the precision required in the inversion of the
       * covariance matrix
       */
      void measure (const std::vector<std::vector<std::vector<double>>> dataset, const double normalization=1, const double prec=1.e-10);
       ...
       * \f$f\f$ is a normalization factor the user can provide in input.
       *
       * This function takes a vector of vectors of doubles. The first index is the considered mock catalogue and the second index is the considered position in the dataset. This should be used when a single probe is considered.
       *
       * @param dataset vector of vectors of doubles
       *
       * @param normalization the normalization factor
       *
       * @param prec the precision required in the inversion of the
       * covariance matrix
       */
      void measure (const std::vector<std::vector<double>> dataset, const double normalization=1, const double prec=1.e-10);
      
      /**
      * @brief regularize the covariance matrix using the Tikhonov regularization.
      */
      void regularize ();
      ...
      /**
       *  @brief print the covariance matrix on standard output
       *
       *  @param prec the float precision
       */
      void print (const int prec=4) const;
