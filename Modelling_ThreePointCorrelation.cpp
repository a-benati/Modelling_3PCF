...
void cbl::modelling::threept::Modelling_ThreePointCorrelation::set_data_model_zeta_RSD_all_scales (const std::vector<double> r12, const std::vector<double> r13, const std::vector<double> r23, const cosmology::Cosmology cosmology, const double redshift, const string method_Pk, const bool NL, const int max_ll, const double k_min, const double k_max, const int step_k, const double r_min, const double r_max, const int step_r, const bool force_realSpace, const bool use_k, const bool store_output, const string output_root, const int norm, const double prec)
{
  m_data_model.cosmology = make_shared<cosmology::Cosmology>(cosmology);

  m_data_model.r12 = r12;
  m_data_model.r13 = r13;
  m_data_model.r23 = r23;
  m_data_model.redshift = redshift;
  m_data_model.method_Pk = method_Pk;
  m_data_model.NL = NL;
  m_data_model.k_min = k_min;
