...
namespace cbl {
  ...
  namespace modelling {
	...
	///@}
         ...
         * (see Slepian & Eisenstein 2017, after having revised some incorrect terms)
         *
	...
	/**
         ...
         * 
         */
	void set_model_RSD_all_scales (const statistics::PriorDistribution b1_prior, const statistics::PriorDistribution b2_prior, const statistics::PriorDistribution bt_prior, const statistics::PriorDistribution beta_prior);
