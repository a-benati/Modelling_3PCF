...
namespace cbl {
  ...
  namespace modelling {
	...
	/**
	 *  @brief set the data model for the three-point correlation
	 *  function (see Slepian, Eisenstein 2017) at all scales
         *
	 *  @param r12 vector containing the first triangle sides
	 *  
	 *  @param r13 vector containing the second triangle sides
	 *
	 *  @param r23 vector containing the third triangle sides
	 *
	 *  @param cosmology the fiducial cosmology
	 *
	 *  @param redshift the redshift
	 ...
	 *  
	 */
	void set_data_model_zeta_RSD_all_scales (const std::vector<double> r12, const std::vector<double> r13, const std::vector<double> r23, const cbl::cosmology::Cosmology cosmology, const double redshift, const std::string method_Pk="CAMB", const bool NL=false, const int max_ll=5, const double k_min=1.e-4, const double k_max=100, const int step_k=500, const double r_min=1.e-4, const double r_max=200, const int step_r=200, const bool force_realSpace=false, const bool use_k=false, const bool store_output=true, const std::string output_root=cbl::par::defaultString, const int norm=-1, const double prec=1.e-4);
	/**
	 *  @brief set the data model for the three-point correlation
