...
namespace cbl {
  ...
  namespace modelling {
    ...
    namespace threept {
      ...
      /**
       *  @brief model for the redshift space connected three-point                                                    
       *  correlation function
       *  Model for the connected three-point correlation function
       *  described in Slepian & Eisenstein (2017) (after having revised some incorrect terms) and implemented in
       *  cbl::cosmology::ThreePointCorrelation::zeta_RSD
       *
     ...
     /**
       *  @brief model for the redshift space connected three-point                                                    
       *  correlation function at all scales
       *  Model for the connected three-point correlation function at all scales
       *  described in Slepian & Eisenstein (2017) (after having revised some incorrect terms) and implemented in
       *  cbl::cosmology::ThreePointCorrelation::zeta_RSD_all_scales
       *
       *  the model has 4 parameters:
       *    - \f$ b_1\f$
       *    - \f$ b_2\f$
       ...
       *
       *  @return the redshift space monopole of the connected
       *  three-point correlation function at all scales
       */
      std::vector<double> zeta_RSD_all_scales (const std::vector<double> index, const std::shared_ptr<void> inputs, std::vector<double> &parameter);
